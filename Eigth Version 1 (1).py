...
image_details = ["camera.jpg"]
file_details = ["TFile1.txt","TFile2.txt","TFile3.txt","TFile4.txt","TFile5.txt","TFile6.txt","TFile7.txt","TFile8.txt","TFile9.txt","TFile10.txt"]
result=[]
for i in file_details:
    work("camera.jpg",i, result)
print(result)
arr = np.asarray(result)
pd.DataFrame(arr).to_csv('samplet1.csv')  
